...
namespace SchoolRegister.Web.Controllers 
{
    ...
    public class TeacherController : BaseController 
    {
        ...
        public TeacherController (ILogger logger,IMapper mapper,IStringLocalizer localizer,IStudentService studentService,ISubjectService subjectService,IGradeService gradeService,ITeacherService teacherService, UserManager<User> userManager) : base (logger, mapper, localizer) 
        {
