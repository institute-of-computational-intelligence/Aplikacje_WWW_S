...
namespace SchoolRegister.Web.Controllers
{
    public class StudentController : BaseController
    {
        ...
        public IActionResult AttachStudentToGroup(AddStudentToGroupVm AddStudentToGroupVm)
        {
            ...
            {
                _groupService.AttachStudentToGroup(AddStudentToGroupVm);
        ...
        [ValidateAntiForgeryToken]
        [Authorize(Roles = "Teacher, Admin")]
        public IActionResult DetachStudentToGroup(RemoveStudentFromGroupVm RemoveStudentFromGroupVm)
        {
            if (ModelState.IsValid)
            {
        ...
        //     }
        //     var attachDetachStudentToGroupDto = new AddStudentToGroupVm
        //     {
        ...
        //         Value = s.Id
        //     }), "Value", "Text");
        //     return View("AttachDetachStudentToGroup", AttachDetachStudentToGroupVm);
        // }
    }
