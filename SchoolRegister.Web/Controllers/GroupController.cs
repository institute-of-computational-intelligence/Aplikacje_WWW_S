...
namespace SchoolRegister.Web.Controllers
{
    ...
    public class GroupController : BaseController
    {
        ...
        public GroupController(ILogger logger, IMapper mapper, IStringLocalizer localizer, IGroupService groupService,
            ISubjectService subjectService, UserManager<User> userManager, IStudentService studentService) : base(
            logger, mapper, localizer)
        {
        ...
        [Authorize(Roles = "Admin")]
        public async Task<ActionResult> Delete(RemoveGroupVm groupVm)
        {
