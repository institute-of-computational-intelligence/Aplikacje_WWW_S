...
namespace SchoolRegister.Web.Controllers
{
    ...
    public class GroupController : BaseController
    {
        ...
        public async Task<IActionResult> AddOrEditGroup(AddGroupVm addGroupVm)
        {
            ...
            {
                var groupVm = await _groupService.AddGroup(addGroupVm);
        ...
        {
            await _groupService.DeleteGroup(groupVm);
        ...
        {
            ViewBag.Student = await _studentService.GetStudent(s => s.Id == studentId);
            return View();
        }
    }
}
