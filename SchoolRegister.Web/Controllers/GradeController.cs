...
namespace SchoolRegister.Web.Controllers
{
    ...
    public class GradeController : BaseController
    {
        ...
        public GradeController(ILogger logger, IMapper mapper, IStringLocalizer localizer,
            IStudentService studentService, IGradeService gradeService, UserManager<User> userManager,
            ITeacherService teacherService, ISubjectService subjectService) : base(logger, mapper, localizer)
        {
        ...
        public async Task<IActionResult> GradesReport()
        {
            ...
            if (_userManager.IsInRoleAsync(user, "Student").Result) return RedirectToAction("GetGradesReport");
        ...
        public async Task<IActionResult> AddGradeToStudent(AddGradeToStudentVm addGradeToStudentVm, string subj)
        {
            ...
            await _teacherService.AddGradeToStudentAsync(addGradeToStudentVm);
