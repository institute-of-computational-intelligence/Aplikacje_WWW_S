...
namespace SchoolRegister.Api.Controllers
{
    ...
    public class TeacherApiController : BaseApiController
    {
        ...
        public TeacherApiController(ILogger logger, IMapper mapper, IEmailSenderService emailSenderService,IGradeService gradeService, ITeacherService teacherService): base(logger, mapper) 
        {
