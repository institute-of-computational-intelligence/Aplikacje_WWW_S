...
namespace SchoolRegister.Services.Services
{
    ...
    public class StudentService : BaseService, IStudentService
    {
        ...
        public void AddStudentToGroup(AddOrRemoveStudentGroupVm addStudentToGroup)
        {
                try{
        ...
        public void RemoveStudentFromGroup(AddOrRemoveStudentGroupVm removeStudentFromGroup)
        {
                try{
